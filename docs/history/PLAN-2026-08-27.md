# Historical work-plan snapshot, 2026-08-27

Preserved from `187248d:PLAN.md` during the 2026-09-06 reconciliation.
This is historical evidence, not current instructions or a second task queue.
Statements about stubs, failing tests, fallback decoders, old CI, and pending
milestones describe their recorded dates and may be superseded later in the
same snapshot. Use [the current plan](../../PLAN.md) for work and status.
