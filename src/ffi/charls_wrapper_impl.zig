...
// Type re-exports live on the public `jpegz` module so we don't
// reference the parent module's source files directly — Zig 0.16
// rejects a file belonging to two modules. build.zig wires
// `addImport("jpegz", jpegz_mod)` for that to resolve here.
